...
pkgdatadir = $(datadir)/Snafucoin
pkgincludedir = $(includedir)/Snafucoin
pkglibdir = $(libdir)/Snafucoin
pkglibexecdir = $(libexecdir)/Snafucoin
...
ACLOCAL = ${SHELL} '/root/snafucoin/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
ARM_CRC_CXXFLAGS = 
AUTOCONF = ${SHELL} '/root/snafucoin/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/root/snafucoin/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/root/snafucoin/build-aux/missing' automake-1.16
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = -I/root/snafucoin/db4/include
BDB_CPPFLAGS = -I/root/snafucoin/db4/include
BDB_LIBS = -L/root/snafucoin/db4/lib -ldb_cxx-4.8
BITCOIN_CLI_NAME = Snafucoin-cli
BITCOIN_DAEMON_NAME = snafucoind
BITCOIN_GUI_NAME = Snafucoin-qt
BITCOIN_TX_NAME = Snafucoin-tx
BITCOIN_WALLET_TOOL_NAME = Snafucoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Snafucoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Snafucoin Core
COPYRIGHT_YEAR = 2024
COV_TOOL = 
COV_TOOL_WRAPPER = 
CPP = gcc -E
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} '/root/snafucoin/build-aux/missing' makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = Snafucoin
PACKAGE_BUGREPORT = https://github.com/Snafucoin-project/Snafucoin/issues
PACKAGE_NAME = Snafucoin Core
PACKAGE_STRING = Snafucoin Core 0.21.4
PACKAGE_TARNAME = Snafucoin
PACKAGE_URL = https://Snafucoin.org/
...
ZMQ_LIBS = -lzmq 
abs_builddir = /root/snafucoin
abs_srcdir = /root/snafucoin
abs_top_builddir = /root/snafucoin
abs_top_srcdir = /root/snafucoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/snafucoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Snafucoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Snafucoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Snafucoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Snafucoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
